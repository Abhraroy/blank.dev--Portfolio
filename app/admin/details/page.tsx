      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-5">
        <div>
          ...
          <h1 className="text-xl font-bold text-zinc-50 flex items-center gap-2 mt-1">
            <FiUser className="text-zinc-300 h-5 w-5" /> My Details & Persona Storytelling
          </h1>
        ...
        >
          <div className="flex items-center justify-between border-b border-white/10 pb-3">
            <h2 className="text-xs font-semibold text-zinc-300 uppercase tracking-[0.2em] flex items-center gap-2">
              <FiUser className="text-zinc-400" /> Core Profile Facts (`MyDetails`)
            </h2>
            {savedFactToast && (
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <FiMail className="absolute left-3.5 top-2.5 text-zinc-500 h-4 w-4" />
                  <input
                    type="email"
                    required
                    value={email}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <div className="relative">
                  <FiMapPin className="absolute left-3.5 top-2.5 text-zinc-500 h-4 w-4" />
                  <input
                    type="text"
                    value={location}
